...
<table cellpadding="0px" width="100%">
	<tbody>
		...
		<tr height="610px" class="p-0">
			<td width="100px"  class="align-top" style="background-color:#95DBE5FF;"><?php echo $this->getChild('left')->toHtml(); ?></td>

			<td><?php echo $this->getChild('content')->toHtml(); ?></td>
			<td width="100px"><?php echo $this->getChild('right')->toHtml(); ?></td>
		</tr>
		<tr height="100px">
